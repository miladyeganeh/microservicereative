...
import com.dv.reviewer.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/microservicereative-kafka")
public class MicroservicereativeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MicroservicereativeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MicroservicereativeKafkaResource(KafkaProperties kafkaProperties) {
